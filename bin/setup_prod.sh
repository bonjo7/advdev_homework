...
oc set resources dc/tasks-blue --limits=memory=1Gi,cpu=1 --requests=memory=1Gi,cpu=1 -n ${GUID}-tasks-prod
...
oc set resources dc/tasks-green --limits=memory=1Gi,cpu=1 --requests=memory=1Gi,cpu=1 -n ${GUID}-tasks-prod
# Setting 'wrong' VERSION. This will need to be updated in the pipeline
